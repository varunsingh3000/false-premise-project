...
def create_parser():
    ...
    parser.add_argument('--QUERY_INTENT_METHOD', type=str, choices=["SemSim", "LLM"],default="SemSim", help='Query intent comparison method to use.')
    ...
    parser.add_argument('--USE_INITIAL_RESP_DATA', type=int, default=0, help='Boolean to decide to whether FPDAR should be used posthoc on initial responses generated by another method')
    ...
    parser.add_argument('--INITIAL_RESP_DATA_PATH', type=str, default="Data\\", help='Path to the initial responses csv file for FPDAR')
    ...
    parser.add_argument('--BACKWARD_REASONING_QUERY_INTENT_PROMPT_PATH', type=str, default="Prompts\\FPDAR\\eval_question_comp.txt", help='Path to the query intent comparison prompt file')
    ...
    parser.add_argument('--LLAMA_BACKWARD_REASONING_QUERY_INTENT_PROMPT_PATH', type=str, default="Prompts\\FPDAR\\eval_question_comp_meta.txt", help='Path to the LLAMA query intent comparison prompt file')
