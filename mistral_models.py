...
def perform_gpt_response(client,variable1,temperature,prompt_path,variable2):
    ...
    message = [
        ChatMessage(role="user", content=file_content.format(variable1,variable2))
    ]
...
def perform_clarification_ques(responses_dict,initial_core_concept,WORKFLOW_RUN_COUNT):
    ...
    result = start_mistral_api_model_response(cq_user_ans,WORKFLOW_RUN_COUNT,external_evidence)
